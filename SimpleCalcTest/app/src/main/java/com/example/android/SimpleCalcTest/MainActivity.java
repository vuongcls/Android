...
//import com.example.android.SimpleCalcTest.Calculator;
//import com.example.android.SimpleCalcTest.R;
...
public class MainActivity extends Activity {
    ...
    private static String getOperandText(EditText operandEditText) {
        ...
        if (TextUtils.isEmpty(operandText)) {
            throw new NumberFormatException("Operand cannot be empty string nè!");
        }
        return operandText;
    }
}